...
- Valeti: Rovo MCP / usuário-accountId / site / projeto / Board / tipos e campos verificados por leitura: [evidências, sem credenciais]
- Valeti: itens do ROADMAP → Tasks pais existentes ou criação sequenciada antes de código; TASKPLAN atual → Subtasks: [vínculos e pendências; não criar planos futuros]
- Valeti: prefixo / branch do pai / PR por repositório e agente de sincronização Jira: [convenção confirmada / ownership / gates de status-coluna]
